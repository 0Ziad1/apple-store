const allProducts = [
    ...
    { name:'Animal Pack', description:'10 Animal Stickers', price:10.99, emoji:'🐶', category:'cute' },
    { name:'Animal Pack', description:'10 Animal Stickers', price:10.99, emoji:'🐶', category:'cute' },
    { name:'Animal Pack', description:'10 Animal Stickers', price:10.99, emoji:'🐶', category:'cute' },
    { name:'Animal Pack', description:'10 Animal Stickers', price:10.99, emoji:'🐶', category:'cute' },
    { name:'Animal Pack', description:'10 Animal Stickers', price:10.99, emoji:'🐶', category:'cute' },
    ...
    { name:'Nature Pack', description:'12 Nature Stickers', price:11.99, emoji:'🌿', category:'art' },
    { name:'Professional Pack', description:'Business Stickers', price:11.99, emoji:'💼', category:'business' },
    { name:'Office Pack', description:'Business Essentials', price:9.99, emoji:'📎', category:'business' },
    ...
    { name:'Cute Mini Pack', description:'5 Cute Stickers', price:6.99, emoji:'💖', category:'cute' },
    { name:'Funny Pack', description:'10 Funny Stickers', price:8.99, emoji:'😂', category:'funny' }
];
